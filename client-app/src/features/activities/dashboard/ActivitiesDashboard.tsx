...
export default  function ActivityDashboard({activities, selectedActivity,canceleActivity,
       openForm, closeForm,selectActivity, editMode, createOrEdit, deleteActivity }:Props) {
